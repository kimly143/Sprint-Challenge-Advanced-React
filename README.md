...
- [x] Build a custom hook and use it in your app -  useLocalStorage hook.
- [x] Write a "reasonable" amount of unit tests for your React components. 
    PlayerCard.test.js

    What does "reasonable amount" mean? That is up to you to decide. Be ready to defend your choice to your TL 👍
    Trying to test App but no idea test state
## Stretch Problems

- [x] Implement another custom hook: implement useDarkMode hook.
